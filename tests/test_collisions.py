...
def test_native_double_underscore_vs_nested_path() -> None:
...
def test_reversed_order_still_raises() -> None:
...
def test_deep_collision_between_branches() -> None:
...
def test_no_collision_when_keys_differ() -> None:
...
def test_native_double_underscore_without_collision() -> None:
